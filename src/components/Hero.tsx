  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-primary/5 rounded-full blur-[80px] animate-float" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="container relative z-10 px-4 py-20">
        ...
        >
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-muted-foreground mb-8 font-sans max-w-2xl mx-auto"
          >
            Indie hacker building products that solve real problems.
            Writing about startups, code, and the journey of building in public.
          </motion.p>
          ...
          >
            {[
              ...
              <a
                key={label}
                href={href}
                className="p-3 rounded-lg border border-border bg-card/50 hover:bg-secondary hover:border-primary/50 transition-all duration-300 group"
                aria-label={label}
              >
